...
const ContactUs = () => {
  ...
  return (
    <motion.div initial="hidden" whileInView="visible" transition={{staggerChildren:0.2}} viewport={{once:true}}
     id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        desc='From strategy to execution, we craft digital solutions tha move your business forward.'/>
