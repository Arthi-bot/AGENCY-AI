...
const ServiceCard = ({service, index}) => {
  ...
  return (
    ...
    onMouseEnter={()=> setVisible(true)} onMouseLeave={()=> setVisible(false)} ref={divRef} onMouseMove={handleMouseMove}>
        ...
        <div className={`pointer-events-none blur-2xl rounded-full bg-linear-to-r from-blue-500 
        via-indigo-500 to-purple-500 w-[300px] h-[300px] absolute z-0 transition-opacity duration-500 mix-blend-lighten
        ...
        rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
            ...
            <div className='bg-gray-100 dark:bg-gray-700 rounded-full'>
                <img src={service.icon} alt="services icon" className='max-w-24 bg-white dark:bg-gray-900 rounded-full m-2'/>
            </div>
